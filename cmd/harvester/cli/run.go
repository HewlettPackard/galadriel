...
func LoadConfig(cmd *cobra.Command) (*harvester.Config, error) {
	...
	if token == "" {
		return nil, fmt.Errorf("join token is required to start the harvester")
	}
...
func init() {
	...
	runCmd.PersistentFlags().StringP("joinToken", "t", "", "A join token generated by Galadriel Server")
